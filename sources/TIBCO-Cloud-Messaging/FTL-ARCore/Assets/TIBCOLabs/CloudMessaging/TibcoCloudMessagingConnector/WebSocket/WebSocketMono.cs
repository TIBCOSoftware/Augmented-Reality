...
namespace Unity3dAzure.WebSockets {
  public class WebSocketMono : IWebSocket {
    ...
    public void ConnectAsync() {
      ...
      AttachHandlers();
      var sslProtocolHack = (System.Security.Authentication.SslProtocols)(SecurityProtocolType.Tls12 | SecurityProtocolType.Tls11 | SecurityProtocolType.Tls);
...
#region WebSocket Handlers
    ...
    private void HandleOnClose(object sender, WebSocketSharp.CloseEventArgs e) {
      ...
      if (OnClose != null) {
        OnClose.Invoke(sender, new WebSocketCloseEventArgs(e.Reason+" "+e.Code, e.Code));
      }
      UnattachHandlers();
      Dispose();
    }
