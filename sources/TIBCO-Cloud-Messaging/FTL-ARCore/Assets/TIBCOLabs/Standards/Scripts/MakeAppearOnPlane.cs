...
public class MakeAppearOnPlane : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Option Canvas Object transform")]
    Transform m_Canvas;
    ...
    public Quaternion rotation
    {
        ...
        set
        {
            ...
            if (m_SessionOrigin != null)
                m_SessionOrigin.MakeContentAppearAt(content, content.transform.position + m_SessionOrigin.transform.position, m_Rotation);
        }
    }
    ...
    void Update()
    {
        ...
        if (m_RaycastManager.Raycast(touch.position, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            m_SessionOrigin.MakeContentAppearAt(content, hitPose.position+ m_SessionOrigin.transform.position, m_Rotation);
